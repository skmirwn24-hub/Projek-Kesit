...
INSERT INTO public.pembayaran_siswa (
  id, siswa_id, paket_siswa_id, nomor_kuitansi, nominal_dibayar, 
  ...
  (
    ...
    '55555555-5555-5555-5555-555555555551', 'KW-20260901-0001',
  ...
  (
    ...
    '55555555-5555-5555-5555-555555555552', 'KW-20260910-0002',
  ...
  (
    ...
    '55555555-5555-5555-5555-555555555553', 'KW-20260915-0003',
...
INSERT INTO public.penilaian_pelatih (
  pelatih_id, tanggal_penilaian, kedisiplinan, kehadiran, kualitas_mengajar,
  ...
  (
    '11111111-1111-1111-1111-111111111111', CURRENT_DATE - INTERVAL '10 days',
    5, 5, 5, 4, 5,
  ...
  (
    '22222222-2222-2222-2222-222222222222', CURRENT_DATE - INTERVAL '7 days',
    4, 4, 4, 5, 4,
  ...
  (
    '33333333-3333-3333-3333-333333333333', CURRENT_DATE - INTERVAL '2 days',
    2, 2, 3, 2, 3,
...
INSERT INTO public.riwayat_perubahan_siswa (
  siswa_id, jenis_perubahan, lokasi_baru, kelas_baru, paket_baru,
  pelatih_pemilik_baru, tanggal_perubahan, alasan, diubah_oleh
) VALUES 
  (
    '44444444-4444-4444-4444-444444444441', 'Pendaftaran Baru',
    'Kolam Renang GOR Bulungan', 'Private', 'Private Bulanan (4x Pertemuan)',
    '11111111-1111-1111-1111-111111111111', CURRENT_DATE - INTERVAL '30 days',
    'Pendaftaran siswa awal', 'Admin KESIT'
  ),
  (
    '44444444-4444-4444-4444-444444444442', 'Pendaftaran Baru',
    'Kolam Renang Bintaro Modern', 'Reguler', 'Reguler Paket 8 Sesi',
